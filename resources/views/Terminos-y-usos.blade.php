...
<head>
    <title>Términos y Condiciones | Fuerza Urbana</title>
...
<section class="py-5 bg-dark text-light">
    <div class="container col-lg-9">
        ...
        <div class="legal-block">
            ...
            <p>
                Se aceptan cambios dentro de los <strong>10 días posteriores</strong> a la recepción del producto.
...
<!-- FOOTER -->
<footer class="bg-black text-center text-secondary py-4 border-top border-danger">
