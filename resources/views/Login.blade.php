    ...
    <div class="col-md-5">
        <div class="card p-4 border border-secondary bg-dark text-white shadow-lg" style="border-radius: 15px;">
            <div class="text-center mb-4">
                <h2 class="fw-bold text-uppercase letter-spacing-2">INGRESAR</h2>
            ...
            <form >
                @csrf <div class="mb-3">
                    ...
                    <input type="email" name="email" id="email" class="form-control form-control-lg bg-black text-white border-secondary rounded-3" placeholder="tu@email.com" required autofocus>
                </div>

                <div class="mb-3">
                    <label for="password" class="form-label fw-bold text-uppercase small" style="letter-spacing: 1px;">Contraseña</label>
                    <input type="password" name="password" id="password" class="form-control form-control-lg bg-black text-white border-secondary rounded-3" placeholder="••••••••" required>
                </div>

                <div class="mb-4 form-check">
                    <input type="checkbox" name="remember" id="remember" class="form-check-input bg-black border-secondary">
                    <label class="form-check-label text-secondary small" for="remember">Recordar mi sesión</label>
                </div>
